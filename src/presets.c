...
static const TimerPreset timer_presets[] = {
    ...
    { "Oolong tea",                  6,   "Partially oxidized tea inspired by shorter gongfu-style infusions" },
    { "Rooibos tea",                 7,   "Naturally caffeine-free infusion" },
    { "Chamomile tea",               8,   "Gentle floral herbal infusion" },
    { "Ginger tea",                  9,   "Warming spicy herbal infusion (infusion; decoction longer)" },
    { "Hibiscus tea",               10,   "Tart floral herbal infusion" },
    { "Masala chai",                11,   "Spiced black tea gently simmered with milk and aromatic spices" },
    { "Peppermint extra strong",    12,   "Extra-potent peppermint herbal infusion with a bold, minty character" },
    { "Cinnamon bark decoction",    15,   "Sweet spiced cinnamon bark simmer" },
    { "Ginger root decoction",      18,   "Deep ginger root decoction" },
    { "Turmeric root decoction",    20,   "Turmeric root decoction for fuller extraction" },
    { "Roasted chicory decoction",  25,   "Slow-simmered roasted chicory root for a coffee-like cup" },
    { "Dandelion root decoction",   30,   "Slow dandelion root decoction" },
    { "Mixed roots long decoction", 60,   "Slow, extended multi-root decoction yielding a rich, full-bodied brew" },
