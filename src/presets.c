...
static const TimerPreset timer_presets[] = {
    ...
    { "Cinnamon bark decoct.",    13,   "Sweet spiced bark simmer (10–15 min)" },
    ...
    { "Dandelion root decoct.",   22,   "Slow roasted root decoction (20–30 min)" },
    ...
    { "Cold brew coffee",        720,   "Long cold coffee extraction (12–24 h)" },
};
